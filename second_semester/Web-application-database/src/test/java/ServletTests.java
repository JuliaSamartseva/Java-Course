...
public class ServletTests {
  ...
  @InjectMocks LoginServlet loginServlet = new LoginServlet();
  @InjectMocks CartServlet cartServlet = new CartServlet();
  @InjectMocks LogoutServlet logoutServlet = new LogoutServlet();
  @InjectMocks ProductsServlet productsServlet = new ProductsServlet();
  @InjectMocks RegistrationServlet registrationServlet = new RegistrationServlet();
  @InjectMocks UsersServlet usersServlet = new UsersServlet();
